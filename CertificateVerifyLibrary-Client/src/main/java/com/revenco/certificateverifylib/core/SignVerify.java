...
public class SignVerify {
    ...
    public enum openDoorStatus {
        certificateIsNullOrEmpty,
        mobileBleMacIsNullOrEmpty,
        convertBeanError,
        publicKeyIsNull,
        deviceIdIsNullOrEmpty,
        //
        NoPermission_VerifyError,
        NoPermission_bleMacIllegal,
        NoPermission_deviceIdNotMatch,
        NoPermission_userIdNotMatch,
        NoPermission_CounterIllegal,
        NoPermission_timeout,
        //
        VerifySuccess,
    }
}
